```bash
┌──(sabeshan㉿kali)-[~]
└─$ nmap -sS -A -sV -T4 10.129.126.22 -vv 
Starting Nmap 7.95 ( https://nmap.org ) at 2025-08-20 18:42 IST
...
Scanning 10.129.126.22 [4 ports]
Completed Ping Scan at 18:42, 0.49s elapsed (1 total hosts)
Initiating Parallel DNS resolution of 1 host. at 18:42
Completed Parallel DNS resolution of 1 host. at 18:42, 0.19s elapsed
Initiating SYN Stealth Scan at 18:42
Scanning 10.129.126.22 [1000 ports]
Discovered open port 22/tcp on 10.129.126.22
Discovered open port 8080/tcp on 10.129.126.22
Discovered open port 8080/tcp on 10.129.126.22
Discovered open port 22/tcp on 10.129.126.22
Discovered open port 8443/tcp on 10.129.126.22
Discovered open port 6789/tcp on 10.129.126.22
Completed SYN Stealth Scan at 18:42, 7.99s elapsed (1000 total ports)
Initiating Service scan at 18:42
Scanning 4 services on 10.129.126.22
Completed Service scan at 18:45, 202.89s elapsed (4 services on 1 host)
Initiating OS detection (try #1) against 10.129.126.22
Initiating Traceroute at 18:46
Completed Traceroute at 18:46, 0.76s elapsed
Initiating Parallel DNS resolution of 2 hosts. at 18:46
Completed Parallel DNS resolution of 2 hosts. at 18:46, 6.64s elapsed
NSE: Script scanning 10.129.126.22.
NSE: Starting runlevel 1 (of 3) scan.
Initiating NSE at 18:46
NSE Timing: About 99.82% done; ETC: 18:46 (0:00:00 remaining)
Completed NSE at 18:46, 40.34s elapsed
NSE: Starting runlevel 2 (of 3) scan.
Initiating NSE at 18:46
Completed NSE at 18:47, 7.31s elapsed
NSE: Starting runlevel 3 (of 3) scan.
Initiating NSE at 18:47
Completed NSE at 18:47, 0.01s elapsed
Nmap scan report for 10.129.126.22
Host is up, received echo-reply ttl 63 (0.41s latency).
Scanned at 2025-08-20 18:42:25 IST for 276s
...
|_http-title: Did not follow redirect to https://10.129.126.22:8443/manage
...
TCP/IP fingerprint:
OS:SCAN(V=7.95%E=4%D=8/20%OT=22%CT=1%CU=37644%PV=Y%DS=2%DC=T%G=Y%TM=68A5CAC
OS:D%P=x86_64-pc-linux-gnu)SEQ(SP=104%GCD=1%ISR=10B%TI=Z%CI=Z)OPS(O1=M569ST
OS:11NW7%O2=M569ST11NW7%O3=M569NNT11NW7%O4=M569ST11NW7%O5=M569ST11NW7%O6=M5
OS:69ST11)WIN(W1=FE88%W2=FE88%W3=FE88%W4=FE88%W5=FE88%W6=FE88)ECN(R=Y%DF=Y%
OS:T=40%W=FAF0%O=M569NNSNW7%CC=Y%Q=)T1(R=Y%DF=Y%T=40%S=O%A=S+%F=AS%RD=0%Q=)
...
Uptime guess: 0.001 days (since Wed Aug 20 18:45:56 2025)
...
HOP RTT       ADDRESS
1   750.63 ms 10.10.16.1
2   750.73 ms 10.129.126.22
...
Nmap done: 1 IP address (1 host up) scanned in 277.03 seconds
           Raw packets sent: 1204 (55.044KB) | Rcvd: 1197 (50.052KB)
```
