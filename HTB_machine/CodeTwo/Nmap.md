```bash
┌──(sabeshan㉿kali)-[~]
└─$ nmap -sS -A -sV -T4 10.10.11.82 -vv   
Starting Nmap 7.95 ( https://nmap.org ) at 2025-08-23 14:34 IST
...
Completed Ping Scan at 14:34, 0.26s elapsed (1 total hosts)
Initiating Parallel DNS resolution of 1 host. at 14:34
Completed Parallel DNS resolution of 1 host. at 14:34, 0.16s elapsed
...
Discovered open port 8000/tcp on 10.10.11.82
Completed SYN Stealth Scan at 14:34, 3.06s elapsed (1000 total ports)
Initiating Service scan at 14:34
Scanning 2 services on 10.10.11.82
Completed Service scan at 14:34, 7.35s elapsed (2 services on 1 host)
Initiating OS detection (try #1) against 10.10.11.82
Initiating Traceroute at 14:34
Completed Traceroute at 14:34, 0.27s elapsed
Initiating Parallel DNS resolution of 2 hosts. at 14:34
Completed Parallel DNS resolution of 2 hosts. at 14:34, 6.59s elapsed
NSE: Script scanning 10.10.11.82.
NSE: Starting runlevel 1 (of 3) scan.
Initiating NSE at 14:34
Completed NSE at 14:34, 7.18s elapsed
NSE: Starting runlevel 2 (of 3) scan.
Initiating NSE at 14:34
Completed NSE at 14:34, 1.11s elapsed
NSE: Starting runlevel 3 (of 3) scan.
Initiating NSE at 14:34
Completed NSE at 14:34, 0.00s elapsed
Nmap scan report for 10.10.11.82
Host is up, received echo-reply ttl 63 (0.20s latency).
Scanned at 2025-08-23 14:34:22 IST for 29s
...
TCP/IP fingerprint:
OS:SCAN(V=7.95%E=4%D=8/23%OT=22%CT=1%CU=44700%PV=Y%DS=2%DC=T%G=Y%TM=68A9843
OS:3%P=x86_64-pc-linux-gnu)SEQ(SP=104%GCD=1%ISR=10A%TI=Z%CI=Z%II=I%TS=A)OPS
...
Uptime guess: 17.075 days (since Wed Aug  6 12:47:22 2025)
...
HOP RTT       ADDRESS
1   261.55 ms 10.10.14.1
2   261.57 ms 10.10.11.82
...
Nmap done: 1 IP address (1 host up) scanned in 31.25 seconds
           Raw packets sent: 1276 (57.042KB) | Rcvd: 1130 (45.998KB)
------------------------------------------------------------------------------------------------------
```
