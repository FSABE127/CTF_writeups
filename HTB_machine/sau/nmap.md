```bash
┌──(sabeshan㉿kali)-[~]
└─$ nmap -sS -A -sV -T4 10.10.11.224 -vv
Starting Nmap 7.95 ( https://nmap.org ) at 2025-08-28 17:33 IST
...
Scanning 10.10.11.224 [4 ports]
Completed Ping Scan at 17:33, 0.27s elapsed (1 total hosts)
Initiating Parallel DNS resolution of 1 host. at 17:33
Completed Parallel DNS resolution of 1 host. at 17:33, 0.10s elapsed
...
Completed SYN Stealth Scan at 17:33, 15.47s elapsed (1000 total ports)
Initiating Service scan at 17:33
Scanning 2 services on 10.10.11.224
Completed Service scan at 17:34, 32.22s elapsed (2 services on 1 host)
Initiating OS detection (try #1) against 10.10.11.224                                                    
Initiating Traceroute at 17:34                                                                           
Completed Traceroute at 17:34, 0.22s elapsed                                                                   
Initiating Parallel DNS resolution of 2 hosts. at 17:34                                                                       
Completed Parallel DNS resolution of 2 hosts. at 17:34, 6.56s elapsed                                                         
NSE: Script scanning 10.10.11.224.                                                                                            
NSE: Starting runlevel 1 (of 3) scan.                                                                                                  
Initiating NSE at 17:34                                                                                                                          
Completed NSE at 17:34, 6.43s elapsed                                                                                                            
NSE: Starting runlevel 2 (of 3) scan.                                                                                                            
Initiating NSE at 17:34                                                                                                                                      
Completed NSE at 17:34, 0.46s elapsed
NSE: Starting runlevel 3 (of 3) scan.
Initiating NSE at 17:34
Completed NSE at 17:34, 0.00s elapsed
Nmap scan report for 10.10.11.224
Host is up, received echo-reply ttl 63 (0.21s latency).
Scanned at 2025-08-28 17:33:31 IST for 64s
...
|     Date: Thu, 28 Aug 2025 12:04:25 GMT
|     Content-Length: 75
...
|     Location: /web
|     Date: Thu, 28 Aug 2025 12:04:06 GMT
|     Content-Length: 27
|     href="/web">Found</a>.
|   HTTPOptions: 
|     HTTP/1.0 200 OK
|     Allow: GET, OPTIONS
|     Date: Thu, 28 Aug 2025 12:04:07 GMT
|     Content-Length: 0
|   OfficeScan: 
...
SF-Port55555-TCP:V=7.95%I=7%D=8/28%Time=68B045A9%P=x86_64-pc-linux-gnu%r(G
SF:etRequest,A2,"HTTP/1\.0\x20302\x20Found\r\nContent-Type:\x20text/html;\
SF:x20charset=utf-8\r\nLocation:\x20/web\r\nDate:\x20Thu,\x2028\x20Aug\x20
SF:2025\x2012:04:06\x20GMT\r\nContent-Length:\x2027\r\n\r\n<a\x20href=\"/w
SF:eb\">Found</a>\.\n\n")%r(GenericLines,67,"HTTP/1\.1\x20400\x20Bad\x20Re
SF:quest\r\nContent-Type:\x20text/plain;\x20charset=utf-8\r\nConnection:\x
SF:20close\r\n\r\n400\x20Bad\x20Request")%r(HTTPOptions,60,"HTTP/1\.0\x202
SF:00\x20OK\r\nAllow:\x20GET,\x20OPTIONS\r\nDate:\x20Thu,\x2028\x20Aug\x20
SF:2025\x2012:04:07\x20GMT\r\nContent-Length:\x200\r\n\r\n")%r(RTSPRequest
...
SF:Bad\x20Request\r\nContent-Type:\x20text/plain;\x20charset=utf-8\r\nX-Co
SF:ntent-Type-Options:\x20nosniff\r\nDate:\x20Thu,\x2028\x20Aug\x202025\x2
...
TCP/IP fingerprint:
OS:SCAN(V=7.95%E=4%D=8/28%OT=22%CT=1%CU=37036%PV=Y%DS=2%DC=T%G=Y%TM=68B045D
OS:3%P=x86_64-pc-linux-gnu)SEQ(SP=106%GCD=1%ISR=10A%TI=Z%CI=Z%II=I%TS=A)OPS
...
Uptime guess: 17.956 days (since Sun Aug 10 18:38:37 2025)
...
HOP RTT       ADDRESS
1   214.80 ms 10.10.14.1
2   208.46 ms 10.10.11.224
...
Nmap done: 1 IP address (1 host up) scanned in 64.90 seconds
           Raw packets sent: 1136 (50.818KB) | Rcvd: 1117 (45.410KB)
```
